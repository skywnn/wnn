...
class FinanceModel extends BaseModel
{
     ...
     */
    public function getFinanceByWhere($map, $Nowpage, $limits,$od)
    {
     ...
     */
    public function getCountFinance($map)
    {
     ...
     * [updateArticle 编辑文章]
     */
    public function editFinance($param)
    {
        Db::startTrans();// 启动事务
        try{
     ...
     */
    public function getOneFinance($id)
    {
