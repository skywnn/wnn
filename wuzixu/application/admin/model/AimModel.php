...
class AimModel extends BaseModel
{
     ...
     */
    public function getAimByWhere($map, $Nowpage, $limits,$od)
    {
     ...
     * [insertArticle 添加文章]
     */
    public function insertAim($param)
    {
        Db::startTrans();// 启动事务
        try{
     ...
     * [articleState 文章状态]
     */
    public function aimState($id,$num){
        if($num == 2){
            $msg = '禁用';
        }else{
            $msg = '启用';
