...
class SurnameModel extends BaseModel
{
     ...
     */
    public function getSurnameByWhere($map, $Nowpage, $limits,$od)
    {
     ...
     */
    public function getCountSurname($map)
    {
     ...
     * [insertArticle 添加文章]
     */
    public function insertSurname($param)
    {
        Db::startTrans();// 启动事务
        try{
     ...
     * [updateArticle 编辑文章]
     */
    public function editSurname($param)
    {
        Db::startTrans();// 启动事务
        try{
     ...
     */
    public function getOneSurname($id)
    {
     ...
     * [articleState 文章状态]
     */
    public function surnameState($id,$num){
        if($num == 2){
            $msg = '禁用';
        }else{
            $msg = '启用';
