...
//*********************************************广告管理*********************************************//
    ...
    public function adverPic($id){
        ...
        $data = $adver->getOneAdver($id);
        $this->assign('item',$data);
        $pic['width'] = Config::get('app.upload_image.lunboWidth');
        $pic['height'] = Config::get('app.upload_image.lunboHeight');
        $this->assign('pic',$pic);
    ...
    public function uplaodPic($id){
        if(request()->isPost()){
            ...
            $width = Config::get('app.upload_image.lunboWidth');
            $height = Config::get('app.upload_image.lunboHeight');
