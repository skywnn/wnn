...
class ContractModel extends BaseModel
{
    ...
    {
        return $this->alias ('r')
            ->field('r.id,r.title,r.cate_id,r.content,r.editor,r.company_id,r.operate_id,r.create_time,r.update_time,r.status,rc.name')
            ->join('contract_cate rc', 'r.cate_id = rc.id')
            ->where($map)
            ->page($Nowpage, $limits)
            ->order($od)
            ->select();
