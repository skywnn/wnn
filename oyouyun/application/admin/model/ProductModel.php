...
class ProductModel extends BaseModel
{
    ...
    {
        return $this->alias ('r')
            ->field('r.id,r.title,r.cate_id,r.favorite_num,r.pic,r.keywords,r.content,r.views,r.is_rec,r.company_id,r.operate_id,r.create_time,r.update_time,r.status,r.sort,rc.name')
    ...
    public function insertProduct($param)
    {
        ...
        try{
            ...
            Db::commit();// 提交事务
            return ['code' => 200, 'data' => $param, 'msg' => '企业服务添加成功'];
        }catch( \Exception $e){
            Db::rollback();// 回滚事务
            return ['code' => 100, 'data' => '', 'msg' =>'企业服务添加失败'];
        }
    }
    ...
    public function editProduct($param)
    {
        ...
        try{
            ...
            Db::commit();// 提交事务
            return ['code' => 200, 'data' => '', 'msg' => '企业服务编辑成功'];
        }catch( \Exception $e){
            Db::rollback();// 回滚事务
            return ['code' => 100, 'data' => '', 'msg' => '企业服务编辑失败'];
        }
    }
