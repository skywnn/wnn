...
class ArticleModel extends BaseModel
{
    ...
    {
        return $this->alias ('r')
            ->field('r.id,r.title,r.cate_id,r.pic,r.summary,r.keywords,r.content,r.views,r.add_like,r.is_rec,r.source,r.editor,r.company_id,r.operate_id,r.create_time,r.update_time,r.status,rc.name')
