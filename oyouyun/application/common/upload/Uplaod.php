...
class Uplaod
{
     ...
     */
    public function baseUplaod($file='file', $pathNewName='goods_icon')
    {
    ...
    /**
     * [defaultUplaod 单一图片上传]
     */
    public function defaultUplaod($file='image', $pathNewName='goods_icon', $isThumb=false, $id, $width, $height)
    {
        $file = request()->file($file);
        $file_info = $file->getInfo();
        $fileConfig = Config::get('app.upload_image');//上传的图片配置
