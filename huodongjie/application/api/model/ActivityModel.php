...
class ActivityModel extends BaseModel
{
    ...
    {
        return $this->alias ('r')
            ->field('r.id,r.title,r.cate_id,r.pic,r.summary,r.keywords,r.content,r.views,r.province_id,r.city_id,r.area_id,r.tel,r.add_like,r.is_rec,r.start_time,r.end_time,r.address,r.is_pay,r.price,r.editor,r.company_id,r.operate_id,r.create_time,r.update_time,r.status,r.sort,rc.name')
